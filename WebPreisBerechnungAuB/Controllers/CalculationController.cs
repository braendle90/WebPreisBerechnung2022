...
namespace WebPreisBerechnungAuB.Controllers
{
    public class CalculationController : Controller
    {
        ...
        public CalculationController(ApplicationDbContext context, UserManager<ApplicationUser> userManager)
        {
        ...
        public async Task<IActionResult> Index(string? id)
        {
            ...
            if (checkOfferId == null)
                return NotFound();

            if (checkOfferId.User != user)
                return NotFound();

            //var positonLogoList = await _getFromDB.loadAllPositionLogosByOfferIdAndUser(id, user);
